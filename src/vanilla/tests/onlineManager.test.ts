...
import { OnlineManager, createOnlineManager } from '../onlineManager'
...
describe('onlineManager', () => {
  ...
  it('setEventListener should use online boolean arg', async () => {
    let count = 0
  ...
  it('cleanup (removeEventListener) should not be called if window is not defined', async () => {
  ...
  it('cleanup (removeEventListener) should not be called if window.addEventListener is not defined', async () => {
  ...
  it('it should replace default window listener when a new event listener is set', async () => {
